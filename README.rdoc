...
[@schmeadyy](https://github.com/shmeadyy)
[@trostli](https://github.com/trostli)
[@JonathanTR](https://github.com/JonathanTR)

== Brief Overview

* We created this web app in order to have a forum to post technical interview questions and be able to discuss them.

== My Role in the Project
* I paired with [@schmeadyy](https://github.com/shmeadyy) to develop the user ability to ask questions and the associated controller routes
